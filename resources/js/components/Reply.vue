      ...
      <div class="flex">
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center pt-2 -ml-2">
            ...
            <button
              class="focus:outline-none text-center hover:text-green-500 hover:bg-green-200 p-2 rounded-xl text-gray-600 flex items-center"
            ...
            >
              ...
              <span class="text-xs" v-if="!reply.parent_id">{{
                replies_count
              }}</span>
            </button>
          </div>
