            ...
            <ais-search-box show-loading-indicator>
                ...
                <div slot-scope="{ currentRefinement, isSearchStalled, refine }">
                    <input
                        ...
                        class="bg-gray-200 appearance-none border-2 border-gray-200 w-full rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                        @input="refine($event.currentTarget.value)"
                    >
                    <span :hidden="!isSearchStalled" class="loader"></span>
                </div>
